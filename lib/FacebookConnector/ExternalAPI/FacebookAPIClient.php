...
class FacebookAPIClient
{
     ...
     * @var string
     */
    protected $graph = 'https://graph.facebook.com/v8.0/';
    ...
    {
        if ((isset($message['message']) && !empty($message['message'])) || isset($message['sender_action'])) {
    ...
    protected function graph($method, $uri, array $options = [])
    {
        ...
        try {
            ...
            //This is made to prevent an error caused for the "Messenger API Updates for Europe", when the bot is "typing"
            //https://developers.facebook.com/docs/messenger-platform/europe-updates/#error-message
